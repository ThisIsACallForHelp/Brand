...
{
    public class DBContext : IDBContext //inherit from IDBContext
    {
        ...
        private DBContext() //Constructor 
        {
            ...
            this.connection.ConnectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + Directory.GetCurrentDirectory() + "\\AppData\\NewMallDataBase.accdb"; 
            //DB link
